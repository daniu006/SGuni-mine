...
CREATE TABLE "cycle_reference" (
    ...
    CONSTRAINT "cycle_reference_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "student_subject_cycleId_idx" ON "student_subject"("cycleId");
...
-- AddForeignKey
ALTER TABLE "student_subject" ADD CONSTRAINT "student_subject_cycleId_fkey" FOREIGN KEY ("cycleId") REFERENCES "cycle_reference"("id") ON DELETE SET NULL ON UPDATE CASCADE;
